...
export default function RegistrationForm() {
  ...
  return <form onSubmit={submit} className="soft-panel p-5 sm:p-8">
    <div><p className="text-sm font-semibold uppercase tracking-[0.16em] text-blue-royal">Pendaftaran lembaga</p><h2 className="mt-2 text-2xl font-bold text-navy-deep sm:text-3xl">Daftarkan Sekolah atau Yayasan</h2><p className="mt-2 text-sm leading-6 text-slate-600">Lengkapi data lembaga Anda. Semua pendaftaran akan diperiksa oleh admin BMPS Bogor.</p></div>
