...
export default function ProgramCard({ program }: { program: Program }) {
  return (
    <Link
      ...
      className="group flex h-full w-full min-w-0 max-w-full flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_12px_30px_rgba(15,23,42,0.05)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_18px_35px_rgba(15,23,42,0.08)] sm:p-5"
    >
      ...
      <h3 className="max-w-full break-words text-2xl font-bold leading-[1.3] text-navy-deep sm:text-lg sm:leading-snug">
        {program.title}
      </h3>
